...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  specializationsLoading,TResult Function( List<SpecializationsData?>? specializations)?  specializationsSuccess,TResult Function( ErrorHandler errorHandler)?  specializationsError,TResult Function( List<Doctors?>? doctors)?  doctorsSuccess,TResult Function( ErrorHandler errorHandler)?  doctorsError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return specializationsSuccess(_that.specializations);case SpecializationsError() when specializationsError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  specializationsLoading,required TResult Function( List<SpecializationsData?>? specializations)  specializationsSuccess,required TResult Function( ErrorHandler errorHandler)  specializationsError,required TResult Function( List<Doctors?>? doctors)  doctorsSuccess,required TResult Function( ErrorHandler errorHandler)  doctorsError,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case SpecializationsLoading():
return specializationsLoading();case SpecializationsSuccess():
return specializationsSuccess(_that.specializations);case SpecializationsError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  specializationsLoading,TResult? Function( List<SpecializationsData?>? specializations)?  specializationsSuccess,TResult? Function( ErrorHandler errorHandler)?  specializationsError,TResult? Function( List<Doctors?>? doctors)?  doctorsSuccess,TResult? Function( ErrorHandler errorHandler)?  doctorsError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case SpecializationsLoading() when specializationsLoading != null:
return specializationsLoading();case SpecializationsSuccess() when specializationsSuccess != null:
...
class SpecializationsSuccess implements HomeState {
  const SpecializationsSuccess(final  List<SpecializationsData?>? specializations): _specializations = specializations;
  

 final  List<SpecializationsData?>? _specializations;
 List<SpecializationsData?>? get specializations {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecializationsSuccess&&const DeepCollectionEquality().equals(other._specializations, _specializations));
}
